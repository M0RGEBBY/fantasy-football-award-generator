...
export default function CertificateCanvas() {
  ...
  const handlePrint = () => {
    ...
    styleEl.innerHTML = `
      ...
      @media print {
        ...
        .printable-certificate [class*="border-dashed"],
        .printable-certificate label[title^="Upload"],
        .printable-certificate .cursor-pointer.bg-yellow-600 { display: none !important; }
        .printable-certificate img { visibility: visible !important; display: block !important; }
      }
  ...
  // Golden text style
const goldTextStyle = {
  color: "#b8860b", // Dark goldenrod — dark, rich gold
  textShadow: `
    0 1px 1px rgba(0,0,0,0.7),   /* deeper shadow for contrast */
    0 1px 3px rgba(0,0,0,0.5),
    0 0 1px rgba(184,134,11,0.3) /* subtle glow to retain metallic feel */
  `,
};
